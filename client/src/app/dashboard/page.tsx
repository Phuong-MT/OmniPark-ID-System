...
import { CheckCircle2, ShieldAlert, Cpu, MapPin, Activity } from 'lucide-react';
                ...
                <Card className="lg:col-span-2">
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div key={i} className="flex items-center gap-4 border-b border-zinc-100 dark:border-zinc-800 pb-4 last:border-0 last:pb-0">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        <p className="text-sm font-medium leading-none">Vehicle Entry Logged</p>
                                        <p className="text-xs text-zinc-500 dark:text-zinc-400">Main Gate, Park Alpha</p>
                                    </div>
