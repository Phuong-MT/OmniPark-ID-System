            ...
            <div className="grid gap-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Customize how the OmniPark interface looks.</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center justify-between py-2">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-zinc-500">Receive emails for security events.</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between py-2 border-t border-zinc-100 dark:border-zinc-800">
                            <div className="space-y-1">
                                <p className="text-sm font-medium leading-none">Device Offline Status</p>
                                <p className="text-sm text-zinc-500">Alerts when infrastructure goes down.</p>
                            </div>
                            <div className="w-10 h-6 bg-blue-600 rounded-full relative cursor-pointer border-2 border-transparent transition-colors">
                                <div className="w-5 h-5 bg-white rounded-full absolute right-0 top-0 shadow-sm" />
                            </div>
                        ...
                        <div className="flex items-center justify-between py-2 border-t border-zinc-100 dark:border-zinc-800">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-zinc-500">Occupancy and usage summaries.</p>
                            </div>
